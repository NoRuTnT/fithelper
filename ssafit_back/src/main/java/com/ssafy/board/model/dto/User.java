...
public class User {
	...
	private String id; // 로그인시 이용하는 사용자의 id
	...
	private String role; // 권한 나누기
	public User() {
	}
	
	public User(String userId, String id, String levelId, String name, String password, String nickname, String birth,
	...
	public String toString() {
		return "User [userId=" + userId + ", id=" + id + ", levelId=" + levelId + ", name=" + name + ", password="
